<template>
  <div class="cont">
    <!-- возможный контент+форма поиска/фильтрации -->
    <v-card-title>
      <a
...
export default {
  data() {
    return {
      ...
      wagons: [], //стартовое значение массива с данными по вагонам
      editedIndex: -1, //стартовое значение индекса редактируемого вагона в массиве
      editedItem: {}, //стартовое значение данных по редактирумого вагону
      validItem: 1, //состояние валидности введенных пользователем данных
